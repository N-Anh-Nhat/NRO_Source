            ...
            switch (character.TypeMenu)
            {
                case 0:
                {
                    switch(select)
                    {
                        ...
                        case 8: //set huy diet de tu kame bien khi + 80% mau
                        {
                            List<int> setHuyDiet = new List<int> { 650, 651, 656, 657, 658};
                            var saophale = new OptionItem() { Id = 107, Param = 9 }; // 9 sao
                            var setsgk = new OptionItem() { Id = 129, Param = 0 }; // set sgk
                            var setsgkop = new OptionItem() { Id = 141, Param = 0 }; // set sgk
                            var setnappa = new OptionItem() { Id = 135, Param = 0 }; // set nappa
